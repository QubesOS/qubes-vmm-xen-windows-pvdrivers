@echo off
cmd /C "C:\WinDDK\6001.17121\bin\setenv.bat C:\WinDDK\6001.17121\ chk W2K && CD \Projects\win-pvdrivers.hg && build -cZg"
...
cmd /C "C:\WinDDK\6001.17121\bin\setenv.bat C:\WinDDK\6001.17121\ chk WLH && CD \Projects\win-pvdrivers.hg && build -cZg"
cmd /C "C:\WinDDK\6001.17121\bin\setenv.bat C:\WinDDK\6001.17121\ chk x64 WLH && CD \Projects\win-pvdrivers.hg && build -cZg"

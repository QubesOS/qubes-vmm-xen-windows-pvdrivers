...
"%WIX%\bin\light.exe" -o gplpv_%BUILD_ALT_DIR%_%GPLPV_VERSION%.msi installer.wixobj "%DIFXLIB%" -ext "%WIX%\bin\WixUIExtension.dll" -ext "%WIX%\bin\WixDifxAppExtension.dll" -ext "%WIX%\bin\WixIIsExtension.dll"

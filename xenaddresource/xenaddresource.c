...
XenAddResource_EvtDeviceFilterAddResourceRequirements(WDFDEVICE Device, WDFIORESREQLIST IoResourceRequirementsList)
{
  ...
  descriptor.u.Memory.MinimumAddress.QuadPart = 0x0000000000000000;
  ...
  descriptor.u.Interrupt.MaximumVector = 46;
  ...
  KdPrint((__DRIVER_NAME " <-- DeviceFilterAddResourceRequirements\n"));

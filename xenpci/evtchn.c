...
static VOID EvtChn_DpcBounce(PRKDPC Dpc, PVOID Context, PVOID SystemArgument1, PVOID SystemArgument2)
{
...
BOOLEAN EvtChn_EvtInterruptIsr(WDFINTERRUPT interrupt, ULONG message_id)
{
    /*
...
NTSTATUS EvtChn_EvtInterruptEnable(WDFINTERRUPT interrupt, WDFDEVICE device)
{
...
NTSTATUS EvtChn_EvtInterruptDisable(WDFINTERRUPT interrupt, WDFDEVICE device)
{
    NTSTATUS status = STATUS_SUCCESS;
...
VOID EvtChn_PdoEventChannelDpc(PVOID context)
{
    PXENPCI_DEVICE_DATA xpdd = context;
